      ...
      >
        ...
        <el-form-item label="预设分类" prop="category">
          <el-select
            ...
            style="width: 100%"
          >
            <el-option label="常用预设" value="common" />
            <el-option label="推荐预设" value="recommended" />
            <el-option label="隐藏预设" value="hidden" />
          </el-select>
        </el-form-item>
          ...
          <div class="tools-editor">
            ...
            <div class="tools-help">
              <el-text type="info" size="small">
                ...
                <span v-else-if="toolsOptions.length === 0"
                  >（暂无可用工具）</span
                >
              </el-text>
            </div>
...
const formRules = {
  ...
  category: [{ required: true, message: "请选择预设分类", trigger: "change" }],
  history: [

<template>
    <div class="tool-call-bar">
        <div class="status-icon">
            <span v-if="tool_call_success" class="call-success-icon">
                <div class="checkmark-container">
                    <svg class="checkmark" viewBox="0 0 52 36" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="extra-info">
            <button :class="{active:showExtraInfo,'extra-info-button':true}" @click="showExtraInfo = !showExtraInfo" ref="show-extra-info">

...
<template>
    <div id="sidebar">
        ...
        <div class="options" id="side">
            ...
            <div class="down-half">
                <a href="https://github.com/Pretend-to/mio-chat-backend" target="_blank" class="side-icon">
                    <svg t="1695150961459"  viewBox="0 0 1024 1024" version="1.1"
                ...
                <div class="side-icon" @click="toconfig">
                    <svg t="1695150463577"  viewBox="0 0 1024 1024" version="1.1"

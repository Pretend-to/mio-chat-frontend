        ...
        <div class="upsidebar" id="chat" v-show="showwindow">
            ...
            <div class="options">
                <div id="system">
                    ...
                    <div class="button" @click="client.fullScreen = !client.fullScreen" id="max">
...
.inputbar {
    ...
    display: flex;
    flex-direction: column;
    border: 0rem solid rgba(161, 154, 154, 0.626);
    flex-basis: 11rem;
}
...
.message-body#user>.msg>.content>* {
    background-color: rgb(0, 153, 255);
}

.message-body#user .loader {
    left: -2rem;
    top: calc(45% - 0.3125rem);
}

.message-body#other>.msg>.content {

            ...
            <div class="inputbar" v-show="showwindow">
                <div class="options">
                    ...
                    <div class="bu-emoji">
                        ...
                        <svg @click="tobuttom(1)" t="1695147151930" class="chat-icon" viewBox="0 0 1024 1024"
                            version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4438" width="20" height="20">
                            <path
                    ...
                    <div class="bu-emoji">
                        ...
                        <svg @click="cleanScreen" t="1695147353549" class="chat-icon" viewBox="0 0 1024 1024"
                            version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4763" width="20" height="20">
                            <path
                    ...
                    <div class="bu-emoji">
                        <p id="ho-emoji">语音</p>
                        <svg @click="voiceList" t="1697536440024" class="chat-icon" viewBox="0 0 1024 1024"
                            version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7282" width="24" height="24">
                            <path
                ...
                <div class="input-box">
                    ...
                    <button @click.prevent="send" :disabled="!userInput || !isValidInput(userInput)"
